...
// UpdateServicePolicyParams contains all the bound params for the update service policy operation
...
func (o *UpdateServicePolicyParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
