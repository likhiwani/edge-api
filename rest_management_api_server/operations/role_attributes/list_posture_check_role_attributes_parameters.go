...
// ListPostureCheckRoleAttributesParams contains all the bound params for the list posture check role attributes operation
// typically these are obtained from a http.Request
//
// swagger:parameters listPostureCheckRoleAttributes
