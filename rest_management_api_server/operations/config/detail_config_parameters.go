...
// DetailConfigParams contains all the bound params for the detail config operation
...
func (o *DetailConfigParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
