...
// PatchConfigTypeParams contains all the bound params for the patch config type operation
...
func (o *PatchConfigTypeParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
