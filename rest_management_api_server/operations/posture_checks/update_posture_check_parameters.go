...
// UpdatePostureCheckParams contains all the bound params for the update posture check operation
...
func (o *UpdatePostureCheckParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
