...
// PatchEdgeRouterParams contains all the bound params for the patch edge router operation
...
func (o *PatchEdgeRouterParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
