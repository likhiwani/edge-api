...
// PatchCaParams contains all the bound params for the patch ca operation
...
func (o *PatchCaParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
