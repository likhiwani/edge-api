...
// DetailCaParams contains all the bound params for the detail ca operation
...
func (o *DetailCaParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
    logtrace.LogWithFunctionName()
	var raw string
	if len(rawData) > 0 {
