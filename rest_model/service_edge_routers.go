...
// ServiceEdgeRouters service edge routers
//
// swagger:model serviceEdgeRouters
type ServiceEdgeRouters struct {

	// edge routers
	EdgeRouters []*CommonEdgeRouterProperties `json:"edgeRouters"`
}
